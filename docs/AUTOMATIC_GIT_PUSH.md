...
Tento dokument popisuje automatizáciu pushu na GitHub v rámci XVADUR workspace. Všetky zmeny sa automaticky synchronizujú na GitHub po každom git commite.
...
### 2. Integrácia do `/savegame` Príkazu
